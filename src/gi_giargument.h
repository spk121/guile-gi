...
typedef enum _GIArgumentStatus {
    ...
    GI_GIARGUMENT_WRONG_TYPE_BYTE_ARRAY_ARG,
    GI_GIARGUMENT_WRONG_TYPE_NUMERICAL_ARRAY_ARG,
    GI_GIARGUMENT_ERROR,
...
const static char gi_giargument_error_messages[GI_GIARGUMENT_N_ERRORS][80] = {
    ...
    [GI_GIARGUMENT_WRONG_TYPE_BYTE_ARRAY_ARG] = "Wrong type arg for byte array: bytevector required",
    [GI_GIARGUMENT_WRONG_TYPE_NUMERICAL_ARRAY_ARG] = "Wrong type arg for numerical array: bytevector required",
