...
#define S2C_ARG_DECL const gchar *subr, gint argnum,    \
        GirArgMapEntry *entry, SCM obj,               \
        guint *must_free, GIArgument *arg, gsize *size
#define S2C_ARGS subr, argnum, entry, obj, must_free, arg, size

#define C2S_ARG_DECL const gchar *subr, gint argnum,    \
        GirArgMapEntry *entry, GIArgument *arg,       \
        guint *must_free, SCM *obj, gsize size
#define C2S_ARGS subr, argnum, entry, arg, must_free, obj, size
