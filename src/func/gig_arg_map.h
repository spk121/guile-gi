...
intbool_t gig_amap_output_child_c(GigArgMap *am, int c_output_pos,
                                  int *cinvoke_output_array_size_index);
void gig_amap_c_count(const GigArgMap *am, int *c_input_pos, int *c_output_pos);
intbool_t gig_amap_input_s_2_input_c(const GigArgMap *amap, int s_input, int *c_input);
intbool_t gig_amap_input_s_2_output_c(const GigArgMap *amap, int s_input, int *c_output);
intbool_t gig_amap_input_s_2_child_input_c(const GigArgMap *amap, int s_input, int *c_input);
intbool_t gig_amap_input_s_2_child_output_c(const GigArgMap *amap, int s_input, int *c_output);
intbool_t gig_amap_get_cinvoke_array_length_indices(const GigArgMap *am, int s_input_pos,
                                                    int *c_input_pos, int *c_output_pos);
intbool_t gig_amap_input_i2c(const GigArgMap *amap, int i, int *c);
intbool_t gig_amap_input_i2s(const GigArgMap *amap, int i, int *s);
intbool_t gig_amap_input_c2i(const GigArgMap *amap, int c, int *i);
intbool_t gig_amap_input_s2i(const GigArgMap *amap, int s, int *i);
intbool_t gig_amap_input_c2s(const GigArgMap *amap, int c, int *s);
intbool_t gig_amap_input_s2c(const GigArgMap *amap, int s, int *c);

intbool_t gig_amap_output_i2c(const GigArgMap *amap, int i, int *c);
intbool_t gig_amap_output_i2s(const GigArgMap *amap, int i, int *s);
intbool_t gig_amap_output_c2i(const GigArgMap *amap, int c, int *i);
intbool_t gig_amap_output_s2i(const GigArgMap *amap, int s, int *i);
intbool_t gig_amap_output_c2s(const GigArgMap *amap, int c, int *s);
intbool_t gig_amap_output_s2c(const GigArgMap *amap, int s, int *c);

intbool_t gig_amap_child_i(const GigArgMap *amap, int i, int *ichild);
intbool_t gig_amap_return_child_i(const GigArgMap *amap, int *ichild);
