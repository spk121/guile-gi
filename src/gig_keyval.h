...
typedef void (* GtypeHashValFreeFunc)(scm_t_bits x);
...
scm_t_bits gtype_hash_find_entry(GtypeHash *kv, GType key);
void gtype_hash_add_entry(GtypeHash *kv, GType key, scm_t_bits val);
...
typedef void (* ScmHashKeyFreeFunc)(scm_t_bits x);
...
GType scm_hash_find_entry(ScmHash *kv, scm_t_bits key);
void scm_hash_add_entry(ScmHash *kv, scm_t_bits key, GType val);
