...
invoke_closure(SCM closure, SCM return_type, SCM args)
{
    ...
    SCM_ASSERT_TYPE(scm_is_list(args), args, SCM_ARG2, "%invoke-closure",
                    "list");
...
{
    SCM_ASSERT_TYPE(scm_is_true(scm_procedure_p(procedure)), procedure, SCM_ARG1, "procedure->closure", "procedure");
